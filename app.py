...
<style>
    ...
    /* Світіння для активних елементів */
    ...
    /* Додаткове виділення для заголовків при скролі */
    h1:hover, h2:hover, h3:hover {
        transform: translateX(5px);
        transition: transform 0.3s ease;
    }

    /* Тіні для текстових полів при вводі */
